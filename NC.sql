...
-- kiểm thử
-- cấp phát 3 viên panadol cho bệnh nhân 1
call dispensemedicine(1, 2, 3, @status_msg);
select @status_msg as notification;

-- cấp phát 10 viên panadol cho bệnh nhân 1 
